...
y = 100
#def square(colors_list, size):
    #pendown()
    #pencolor(colors_list)
    #for i in range(4):
        #forward(size)
        #right(90)
    #penup()
...
def colored_house(colors_list, size):
    pendown()
    pencolor(colors_list)
...
for y in range(1):
    pendown()
    colored_house("purple", 150)
    penup()
    forward(200)
for y in range(1):
    pendown()
    colored_house("green", 150)
    penup()
    forward(200)
for y in range(1):
    pendown()
    colored_house("red", 150)
    penup()
    forward(200)
for y in range(1):
    pendown()
    colored_house("orange", 150)
    penup()
    forward(200)
