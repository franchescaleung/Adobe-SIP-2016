...
void loop() {
  tone(PIEZOPIN, 740, eighth_note);
  delay(250);
  tone(PIEZOPIN, 440, eighth_note);
  delay(250);
  tone(PIEZOPIN, 494, quarter_note);
  delay(500);
  tone(PIEZOPIN, 440, quarter_note);
  delay(500);
  tone(PIEZOPIN, 740, quarter_note);
  delay(500);
  tone(PIEZOPIN, 659, eighth_note);
  delay(250);
  tone(PIEZOPIN, 580, eighth_note);
  delay(250);
  tone(PIEZOPIN, 659, quarter_note);
  delay(500);
  tone(PIEZOPIN, 740, eighth_note);
  delay(250);
  tone(PIEZOPIN, 494, eighth_note);
  delay(250);
  tone(PIEZOPIN, 587, half_note); 
  delay(1000);
  //PLAY YOUR SONG HERE
}
